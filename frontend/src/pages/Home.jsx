    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="relative w-full h-[70vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          >
            Travel Together, <span className="text-blue-300">Save Together</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Find affordable rides or offer seats in your car. Connect with verified members
            and make travel more sustainable, affordable, and social.
          </motion.p>
      ...
      <main className="flex-grow flex flex-col items-center px-4 md:px-6 py-16 w-full">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {[
              { step: 1, title: "Search a Ride", text: "Enter your start and end locations, preferred date, and find available rides that match your route." },
              { step: 2, title: "Book & Pay", text: "Select the ride that suits you best, book your seat securely, and pay through our secure payment system." },
              { step: 3, title: "Enjoy the Ride", text: "Meet at the agreed location, travel together, and leave a review after your journey is complete." },
            ].map(({ step, title, text }) => (
